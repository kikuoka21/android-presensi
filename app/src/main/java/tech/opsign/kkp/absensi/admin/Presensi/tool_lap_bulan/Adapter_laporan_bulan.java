...
public class Adapter_laporan_bulan extends RecyclerView.Adapter<Adapter_laporan_bulan.MyViewHolder> {
    private List<Model_laporan_bulan> arrayListData;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Model_laporan_bulan b = arrayListData.get(position);
...
//            holder.bg.setBackgroundColor(0xffC15CF5);
    ...
    public Adapter_laporan_bulan(List<Model_laporan_bulan> arrayListData) {
