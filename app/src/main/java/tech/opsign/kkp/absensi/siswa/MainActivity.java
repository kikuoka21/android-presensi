...
import Tools.appKey;
import id.ac.budiluhur.sim.History.Absensi;
import id.ac.budiluhur.sim.Login.Login;
import id.ac.budiluhur.sim.Profile.DataDiri;
import id.ac.budiluhur.sim.Profile.RiwayatPekerjaan;
import id.ac.budiluhur.sim.SuratIzin.HistoriIzin;
import id.ac.budiluhur.sim.SuratIzin.Menunggu_Persetujuan;
import id.ac.budiluhur.sim.SuratIzin.Pengajuan_surat;
...
//                            editor.putString(key.key(4919), data.getString("tahun_ajar"));
//                            editor.putString(key.key(5784), data.getString("tanggal"));
                            editor.commit();
                        } else {
                            ab
...
//            StrictMode.setThreadPolicy(policy);
//
//            JSONObject nama = new JSONObject(sp.getString(key.key(1102), ""));
//            JSONObject foto = new JSONObject(sp.getString(key.key(8920), ""));
