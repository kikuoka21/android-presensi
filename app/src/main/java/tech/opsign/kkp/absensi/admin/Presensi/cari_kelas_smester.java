...
public class cari_kelas_smester extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static SharedPreferences sp;
    private cari_kelas_smester activity;
    ...
    private String str_thn, smester;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        handler = new Handler();
        setTitle("Cari Kelas - Laporan Semester");
        ...
        Spinner spiner = findViewById(R.id.smester);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        smester = parent.getItemAtPosition(position).toString().substring(0, 2);
        Log.e("ER", smester);
    }
